var dragManager = new function() {
  ...
  */
  ...
  function findDraggable(event) {
    ...
    while(elem != document && (elem.parentNode.getAttribute('draggable') || elem.parentNode.parentNode.parentNode.getAttribute('draggable')) == null ) {
      elem = elem.parentNode;
    }
    return elem == document ? null : elem.firstChild;
  }
